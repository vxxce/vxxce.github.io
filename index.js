...
const randomizeEm = n => {
    ...
    titleBorder += 0.0015
    title.style.borderBottom = `${titleBorder.toString().concat('rem')} solid rgb(231, 222, 210)`
    title.style.transform = `translate(${titleX.toString() + 'px'}, ${titleY.toString() + 'px'})`
    title.style.color = `rgb(${r}, ${g}, ${b})`
    titleX += Math.round(Math.random()) ? Math.round(Math.random() * 9 + n) : -Math.round(Math.random() * 8 + n)
    titleY += Math.round(Math.random()) ? Math.round(Math.random() * 8 + n) : -Math.round(Math.random() * 6  + n)
    if (!score % 5) {
      titleX -= 15
      titleY -= 18
    }
    ...
    r += Math.round(Math.random()) ? Math.round(Math.random() * 5) : -Math.round(Math.random() * 5)
    g += Math.round(Math.random()) ? Math.round(Math.random() * 5) : -Math.round(Math.random() * 5)
    b += Math.round(Math.random()) ? Math.round(Math.random() * 5) : -Math.round(Math.random() * 5)
    score++
}
